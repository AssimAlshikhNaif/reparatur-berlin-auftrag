            ...
            <tbody>
              {filtered.map((o) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-right whitespace-nowrap sticky right-0 bg-background/95 backdrop-blur-sm z-10 shadow-[-4px_0_8px_-4px_rgba(0,0,0,0.2)] group-hover:bg-muted transition-colors" onClick={(e) => e.stopPropagation()}>
                    <div className="flex items-center justify-end">
                      {canManage && (
                        <button
                          ...
                          className="p-2 border border-border/80 text-accent bg-accent/10 rounded-lg hover:bg-accent hover:text-primary-foreground transition-colors"
                        >
